...
\renewcommand{\abstractname}{\section*{Abstract}\vspace{4ex}}
...
\begin{center}
  \begin{minipage}{0.7\textwidth}
    ...
    \begin{minipage}[b]{0.5\textwidth}
      ...
      \includegraphics[width=0.9\textwidth]{assets/signature.png}
...
\begin{itemize}
  ...
  \item Combined feedback containing
        ...
        \end{itemize}
  \item Two corpora: a \code{InMemoryCorpus} for the working corpus of the fuzzer, and an \code{OnDiskCorpus} for all crashes found.
  \item A \code{StdState} containing a random number generator and the corpora.
...
\begin{figure}
  ...
  \caption{Ratio between incorrect and correct observer measurements for different overcommit values}
...
\begin{figure}
  ...
  \caption{Execution speed for different overcommit values}
...
\subsubsection{Accuracy of State-Inferrence Heuristic and Alternate Uses for State Feedback}
...
\begin{center}
  ...
  \href{https://github.com/riesentoaster/ftz}{github.com/riesentoaster/FTZ}.
\end{center}
% \vspace*{\stretch{1}}

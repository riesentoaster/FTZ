...
\begin{center}
  \begin{minipage}{0.8\textwidth}
    ...
    \begin{abstract}
      ...
      \todo{write}
      \todo{correct title page layout}
      \todo{order of title page, abstract, acknowledgments (right title?), main}
    \end{abstract}
  \end{minipage}
  \vspace{70px}

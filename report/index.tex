...
\begin{multicols}{2}
  ...
  While all of the projects presented above introduce provably effective approaches to increase a fuzzer's performance on their targets by using state feedback, only \todo{which} have the same target as \proj: a TCP/IP stack.

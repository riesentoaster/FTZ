...
random message vs. last message
\subsubsection*{Discussion}

\subsection{Input Modelling and Mutation}
byte array vs. parsed structure

evtl. different levels of mutators
\subsubsection*{Discussion}
